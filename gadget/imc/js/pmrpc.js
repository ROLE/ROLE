...
pmrpc = self.pmrpc =  function() {
  ...
  function processPmrpcMessage(serviceCallEvent, eventSource) {
    ...
    if (serviceCallEvent.data.indexOf("pmrpc.") !== 0) {
      ...
      //console.log(this.location.href + " received:" + serviceCallEvent.data);
      ...
      if (typeof message.method !== "undefined") {
        ...
        if (response !== null) {
          if (message.method === "getDestinationOrigin") {
            ...
            //console.log("sending non-getDescription response");
            //console.log("------------ response target origin: " + newServiceCallEvent.origin);
            //console.log("------------ response target origin: " + serviceCallEvent.origin);
            //console.log("------------ response target origin: " + serviceCallEvent.source.toString());
            sendPmrpcMessage(
  ...
  function call(config) {
    ...
    //console.log(typeof config.destination);
  ...
  function sendPmrpcMessage(destination, message, acl, cbx) {
    ...
    if (acl === "*") {
      ...
      //  console.log("result1: " + result.returnValue);
      //}
      //console.log(typeof cbx);
