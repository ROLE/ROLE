...
function login() {
	...
	username = dijit.byId("xmpp_username").attr("value");
	password = dijit.byId("xmpp_password").attr("value");
	domain = dijit.byId("xmpp_domain").attr("value");
	resource = "role-xmpp-web";
